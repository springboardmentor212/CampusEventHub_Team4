        ...
        <DashboardLayout>
            <div className="max-w-xl mx-auto py-12 animate-fade-in">
                <header className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">Change Password</h1>
                    <p className="text-slate-500 font-medium mt-1">Choose a strong password to protect your account.</p>
                </header>
                ...
                <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-8 md:p-12">
                    ...
                    <div className="mt-8 p-4 bg-slate-50 rounded-2xl border border-slate-100 flex gap-4 items-start">
                        ...
                        <p className="text-[11px] text-slate-500 leading-relaxed font-medium">
                            Use a mix of alphanumeric characters and symbols for better security.
                        </p>
                    </div>
                </div>
            </div>
